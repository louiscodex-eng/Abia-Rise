const nigeriaStatesLGA = {
  ...
  //   "Nsit-Ubium", "Obot Akara", "Okobo", "Onna",
  //   "Oron", "Oruk Anam", "Udung-Uko", "Ukanafun",
  ...
  //   "Oguta", "Ohaji/Egbema", "Okigwe",
  //   "Onuimo", "Orlu", "Orsu", "Oru East",
  ...
  //   "Maigatari", "Malam Madori", "Miga",
  //   "Ringim", "Roni", "Sule Tankarkar",
  //   "Taura", "Yankwashi"
  // ],
  ...
  //   "Kibiya", "Kiru", "Kumbotso", "Kunchi",
  //   "Kura", "Madobi", "Makoda", "Minjibir",
  //   "Nasarawa", "Rano", "Rimin Gado",
  //   "Rogo", "Shanono", "Sumaila",
  //   "Takai", "Tarauni", "Tofa",
  ...
  //   "Ile Oluji/Okeigbo", "Irele", "Odigbo",
  ...
  //   "Jakusko", "Karasuwa", "Machina",
  //   "Nangere", "Nguru", "Potiskum",
  ...
  //   "Shinkafi", "Talata Mafara", "Tsafe",
  //   "Zurmi"
  // ],

  // FCT: [
  //   "Abaji", "Bwari", "Gwagwalada",
  //   "Kuje", "Kwali", "Municipal Area Council"
  // ]
};

export default nigeriaStatesLGA;
